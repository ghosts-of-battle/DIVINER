...
// THE ONE SOURCE OF COLOUR IN THE SUITE. ghostD_tacpad_fnc_theme returns the
...
private _opacity = ((missionNamespace getVariable ["ghostD_tacpad_opacity", 0.92]) max 0.88) min 1;
private _scale = missionNamespace getVariable ["ghostD_tacpad_uiScale", 1];
