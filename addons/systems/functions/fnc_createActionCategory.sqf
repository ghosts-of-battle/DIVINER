 ...
 *
 * Example:
 * [this,"MyCategory","Insignia","icon.paa",["ACE_MainActions"]] call ghostD_systems_fnc_createActionCategory;
 * [this,"MySecondCategory","Misc","data/icon.paa",["ACE_MainActions","MyCategory"]] call ghostD_systems_fnc_createActionCategory;
 */
