 ...
 *
 * Example:
 * [this, true] call ghostD_systems_fnc_doGetOutHeloSide;
 */
...
// NEVER WIRED. A vanilla/CTRG transport list was prepared here and no branch
// below ever reads it - the door handling underneath is RHS-only
// (rhs_fnc_doorHandler, doorLB/doorRB). Vanilla helicopters use different door
// sources, so hooking them up is a change of behaviour, not a tidy-up:
