 ...
 *
 * Example:
 * [ [ "marker_0" , "marker_1" ] , [ "marker_2" , "marker_3" ] , 0.005 , 0 , 0.25] spawn ghostD_systems_fnc_dynamicMarkers;
 *
 * Public: No
 *
 */
 ...
 // Define variables
private _mL = _this select 0;
private _mS = _this select 1;
private _speed = _this select 2;
private _min = _this select 3;
private _max = _this select 4;
