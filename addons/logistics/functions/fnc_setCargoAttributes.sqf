 ...
 *
 * Example:
 * [myTruck] call ghostD_logistics_fnc_setCargoAttributes;
 * [myTruck, 30, -1] call ghostD_logistics_fnc_setCargoAttributes;
 * [myCrate, -1, 2] call ghostD_logistics_fnc_setCargoAttributes;
 * [myCrate, -1, 2, true, false] call ghostD_logistics_fnc_setCargoAttributes;
 * [myCrate, nil, nil, true, false] call ghostD_logistics_fnc_setCargoAttributes;
 *
 * Public: Yes
 */
