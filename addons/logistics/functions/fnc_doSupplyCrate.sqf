 ...
 *
 * Example:
 * [[0.0,0.0,0.0],"crate_resupply_general"] call ghostD_logistics_fnc_doSupplyCrate;
 * [[0.0,0.0,0.0],"crate_medical"] call ghostD_logistics_fnc_doSupplyCrate;
 */
...
switch (_crateType) do {
    ...
    case "crate_resupply_general": {
        _crateModel = "ghostD_equipment_outlawHQ";
    };
    case "crate_reaper";
    case "crate_nomad";
    case "crate_talon": {
        _crateModel = "B_supplyCrate_F";
    };
    case "crate_titan": {
        _crateModel = "ghostD_equipment_AA";
    };
    case "crate_nlaw";
    case "crate_spike";
    case "crate_maaws": {
    ...
    case "crate_javelin": {
        _crateModel = "ghostD_equipment_javlen";
    };
    case "crate_eng": {
        _crateModel = "ghostD_equipment_eng";
    };
    case "crate_m2": {
        _crateModel = "ghostD_equipment_50cal";
    };
    case "crate_mo": {
        _crateModel = "ghostD_equipment_252";
    };
    case "crate_tow": {
        _crateModel = "ghostD_equipment_TOW";
    };
    default {
...
if (typeOf _crate in _smallBox) then {
    _crate setObjectTextureGlobal  [0, "\data\Images\AmmoBox_signs_YMF_ammo_CA.paa"];
};
if (typeOf _crate in _largeBox) then {
    _crate setObjectTextureGlobal  [1, "\data\Images\AmmoBox_signs_YMF_ammo_CA.paa"];
};
