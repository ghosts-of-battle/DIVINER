 ...
 * FUNC(unit_getName) both called ghostD_players_fnc_getClanTag /
 * ghostD_players_fnc_hasClanTag, which existed nowhere - so a name lookup threw
 ...
 *
 * Example:
 * private _tag = call ghostD_players_fnc_getClanTag;
 *
 * Public: Yes
 */
