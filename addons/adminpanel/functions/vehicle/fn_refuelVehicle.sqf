...
["Admin Panel", format ["Fully refueled %1's vehicle!", name _player], [0.4, 0.702, 0.4, 1]] call EFUNC(notify,notify);
playSound "3DEN_notificationDefault";

if (_player != player) then { // show selected player a message
    private _message = format ["%1 refueled your vehicle!", name player];
