 ...
 *
 * Example:
 * [_pool, _pos, west, GVAR(aaLock), "aa", "AIR DEFENCE"] call ghostD_hacking_fnc_ladderCircle
 */
...
// IT USED TO TELL ALiVE. Every circle was reported to the adapter as an intel
// product against the owning side, which fed ALiVE's own intelligence model.
// Nothing consumes that now; the circle on the player's map IS the product.
