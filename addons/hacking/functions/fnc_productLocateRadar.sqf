...
// GHOST'S OWN RADARS, AND ONLY THOSE. ALiVE's radar profiles were a second
// source here, picked out of the adapter by class - the player was hunting eyes
// whoever owned them. What is left is the coastal set, which is the half of the
// anti-ship split this product exists for: kill the radar and the launchers are
// firing blind, kill the launchers and the radar is still watching.
