 ...
 * This module function spawn a Ghosts of Battle Starter Crate.
 *
 * Arguments:
 ...
 *
 * Example:
 * [getPos logic, this] call ghostD_zenmodules_fnc_createStarterCrate;
 *
 * Public: No
 */
...
[
    "Ghosts of Battle Starter Crate", 
    [
    ...
    ],
    {
        ...
        [_crate, _quickSelectScale, true, _reHealOption, true, _allowAllLoadouts] remoteExec [QEFUNC(mission,doStarterCrate), 0, true];
