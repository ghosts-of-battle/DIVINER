 ...
 *
 * Example:
 * [getPos logic, this] call ghostD_zenmodules_fnc_createFieldHospital
 *
 * Public: No
 */
...
[
    "Ghosts of Battle Field Hostpital Crate", 
    [
    ...
    ], 
    {
        ...
        [_crate, false, _size] remoteExec [QEFUNC(logistics,doFieldHospital), 0, true];
