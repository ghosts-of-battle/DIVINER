 ...
 *
 * Example:
 * ["my_c130"] call ghostD_mission_fnc_addHaloJump
 * ["my_c130", 5000] call ghostD_mission_fnc_addHaloJump
 * ["my_c130", 5000, "B_Parachute"] call ghostD_mission_fnc_addHaloJump
 *
 */
...
private _actionID = [
    ...
    {},
    {
        ...
        [_caller, _target, _chuteBackpackClass, _allowStaggared] call EFUNC(systems,para_haloJump)
    },
    {},
