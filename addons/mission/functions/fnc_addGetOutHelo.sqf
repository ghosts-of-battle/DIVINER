 ...
 *
 * Example:
 * [this] call ghostD_mission_fnc_addGetOutHelo
 * [this, true] call ghostD_mission_fnc_addGetOutHelo
 */
...
private _actionIDL = _vehicle addAction [
    _leftSide,
    {[_this select 0, true] call EFUNC(systems,doGetOutHeloSide)},
...
private _actionIDR = _vehicle addAction [
    _rightSide,
    {[_this select 0, false] call EFUNC(systems,doGetOutHeloSide)},
