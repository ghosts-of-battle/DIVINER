 ...
 *
 * Example:
 * [this] call ghostD_mission_fnc_addStagingZone
 * [this, 3] call ghostD_mission_fnc_addStagingZone
 * ["zone_staging", 12] call ghostD_mission_fnc_addStagingZone
 * ["respawn_west", 12] call ghostD_mission_fnc_addStagingZone
 * [[10,25,0], 12] call ghostD_mission_fnc_addStagingZone
 * ["ShapedZoneMarker", "RECTANGLE"] call ghostD_mission_fnc_addStagingZone
 * ["ShapedZoneMarker", "ELLIPSE"] call ghostD_mission_fnc_addStagingZone
 * 
 * Public: Yes
 */
...
if (_zone isEqualType []) exitWith {
    ...
    private _stagingZone = createMarkerLocal [format["YMF_staging_zone_%1", count _stagingZones], _zonePos];
...
// EVERY BRANCH ABOVE exitWith-s. Reaching this line means _zone was none of
// the three supported types, so nothing was created and nothing can be.
ERROR_1("Staging","Staging zone %1 not created - unsupported zone type.",_zone);
