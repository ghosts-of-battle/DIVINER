 ...
 * 4: Chute Vehicle Class <OBJECT> (Optional) (Default; "NonSteerable_Parachute")
 * 5: Staggared Jump <BOOL> (Optional) [Default; false]
 *
 * Example:
 * ["my_c130"] call ghostD_mission_fnc_addLineJump
 * ["my_c130", 180] call ghostD_mission_fnc_addLineJump
 * ["my_c130", 180, 350, 310] call ghostD_mission_fnc_addLineJump
 * ["my_c130", 180, 350, 310, "NonSteerable_Parachute", false] call ghostD_mission_fnc_addLineJump
 *
 */
...
private _actionID = [
    ...
    "z\ghostD\addons\media\images\Icons\icon_02.paa",
    "z\ghostD\addons\media\images\Icons\icon_02.paa",
    ...
    {},
    {
        ...
        [_caller, _target, _chuteVehicleClass, _allowStaggared] call EFUNC(systems,para_lineJump)
    },
    {},
