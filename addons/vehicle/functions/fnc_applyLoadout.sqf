 ...
 *
 * Example:
 * [_vehicle, "default", []] call ghostD_vehicle_fnc_applyLoadout;
 *
 * Public: No
 */
...
// Add magazine
{
    ...
    if (_amount != 0) then {
        INFO_5("VehiclePylonApply","Adding magazine '%1' (%2) in turret %3 to %4 (%5)",_magazineClassname,_amount,_turretPath,_vehicle,typeOf _vehicle);
