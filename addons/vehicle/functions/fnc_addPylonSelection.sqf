 ...
 *
 * Example:
 * [_vehicle, "Default Loadout", "rhsusf_m1a1tank_base", "default", [], ""] call ghostD_vehicle_fnc_addPylonSelection;
 * [_vehicle, _displayName, _vehicleKind, _loadoutName, _pylon, _icon] call ghostD_vehicle_fnc_addPylonSelection;
 * [_vehicle, "Default Loadout", "rhsusf_m1a1tank_base", "default", [_vehicle, "rhsusf_m1a1tank_base", "default"] call ghostD_vehicle_fnc_getPylonLoadout, ""] call ghostD_vehicle_fnc_addPylonSelection;
 *
 * Public: No
 */
