 ...
 *
 * Example:
 * [_vehicle] call ghostD_vehicle_fnc_addStagingActions;
 *
 * Public: No
 */
...
private _stagingCat = [QEGVAR(Actions_Vehicle,Main_Cat), "Vehicle Staging Zone", "z\ghostD\addons\media\images\logo_256.paa", {true}, _condition] call ace_interact_menu_fnc_createAction;
private _actionArray = [_vehicle, 1, ["ACE_SelfActions"], _stagingCat] call ace_interact_menu_fnc_addActionToObject;

private _stagingCat = [QEGVAR(Actions_Vehicle,Cosmetic_Cat), "Vehicle Cosmetics", "z\ghostD\addons\media\images\logo_256.paa", {true}, {true}] call ace_interact_menu_fnc_createAction;
